...
{{-- This is a partial view, so NO @extends or @section --}}
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addMembershipModal">
                        <i class="fa fa-plus me-1"></i> Add Membership
                    </button>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <tbody>
                                @foreach($client->memberships as $clientMembership)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-{{ $clientMembership->status === 'active' ? 'success' : ($clientMembership->status === 'expired' ? 'danger' : 'warning') }}">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" 
                                                        data-bs-target="#redeemModal{{ $clientMembership->id }}">
                                                    <i class="fa fa-ticket-alt"></i> Redeem
                                                </button>
                                                <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" 
                                                        data-bs-target="#editMembershipModal{{ $clientMembership->id }}">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('store.clients.memberships.update', [$client, $clientMembership]) }}" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group mb-3">
                                                                    <label for="sessions_used" class="form-label">Sessions Used</label>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('store.clients.memberships.store', $client) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="sessions_used" class="form-label">Initial Sessions Used (Optional)</label>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (membershipSelect && sessionsUsedInput) {
