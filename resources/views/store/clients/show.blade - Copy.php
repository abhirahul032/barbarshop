        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-body text-center">
                    ...
                    <div class="d-flex justify-content-center gap-2 mb-3">
                        ...
                        <span class="badge bg-info">Has Membership</span>
                        @endif
                    </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        <i class="fab fa-whatsapp {{ $client->whatsapp_notifications ? 'text-success' : 'text-muted' }} me-2"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (emergencyContactForm) {
        ...
        // Real-time validation for emergency contact form
...
// Attach phone formatting to phone inputs
document.addEventListener('DOMContentLoaded', function() {
