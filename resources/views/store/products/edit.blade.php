...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="btn-group">
        <a href="{{ route('store.products.show', $product) }}" class="btn btn-outline-info">
...
<div class="card">
    <div class="card-header bg-warning text-dark">
        <h5 class="card-title mb-0">
            <i class="fa fa-edit me-2"></i>Edit Product: {{ $product->name }}
        </h5>
    </div>
    <div class="card-body">
                    ...
                    <div class="card mb-4 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input name="name" value="{{ old('name', $product->name) }}" class="form-control form-control-lg" required />
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" name="team_commission_enabled" 
                                       @checked(old('team_commission_enabled', $product->team_commission_enabled))>
                                <label class="form-check-label fw-semibold">Enable Team Member Commission</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check form-switch mb-3">
                                ...
                                <label class="form-check-label fw-semibold">Track Stock Quantity</label>
                            </div>
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="low_stock_notifications" 
                                       @checked(old('low_stock_notifications', $product->low_stock_notifications))>
                                <label class="form-check-label fw-semibold">Receive Low Stock Notifications</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-4 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="fw-semibold border-bottom pb-2">Existing Images</h6>
                            @foreach($product->images as $img)
                                <div class="d-flex align-items-center mb-3 p-2 border rounded">
                                    <img src="{{ asset('storage/'.$img->path) }}" class="me-3 rounded" width="60" height="60" style="object-fit: cover;" />
                                    <div class="flex-grow-1">
                                        <small class="text-muted d-block">Image</small>
                                        <form action="{{ route('store.products.update', $product) }}" method="POST" class="mt-1">
                                            @csrf
                                            @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 pt-3 border-top">
                                <div class="text-center">
                                    <small class="text-muted">Last updated: {{ $product->updated_at->format('M j, Y g:i A') }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
