        ...
        <div class="card">
            <div class="card-header bg-transparent">
                <h5 class="card-title text-white mb-0">
                    <i class="fa fa-store me-2"></i>Store Information
                </h5>
            </div>
            <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="name" class="form-control border-start-0 @error('name') is-invalid @enderror" 
                                           value="{{ old('name') }}" required placeholder="Enter store name" />
                                </div>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="url" type="url" class="form-control border-start-0 @error('url') is-invalid @enderror" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="email" type="email" class="form-control border-start-0 @error('email') is-invalid @enderror" 
                                           value="{{ old('email') }}" required placeholder="store@example.com" />
                                </div>
                                @error('email')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="no_of_employees" type="number" class="form-control border-start-0 @error('no_of_employees') is-invalid @enderror" 
                                           value="{{ old('no_of_employees') }}" required min="1" placeholder="Enter number of employees" />
                                </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-end">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fa fa-save me-2"></i>Create Store
                            </button>
