{{-- resources/views/store/suppliers/create.blade.php --}}
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('store.suppliers.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('supplier_description') is-invalid @enderror" 
                                              ...
                                              rows="3" 
                                              placeholder="e.g. Local provider of hair products">{{ old('supplier_description') }}</textarea>
