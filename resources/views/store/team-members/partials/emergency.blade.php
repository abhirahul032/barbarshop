...
<div class="card section-card">
    ...
    <div class="section-body">
        @if(isset($teamMember) && $teamMember->emergencyContacts->count() > 0)
            ...
            <div class="border p-3 mb-3 rounded">
                <div class="d-flex justify-content-between align-items-start">
                    ...
                    <form action="{{ route('team-members.emergency-contacts.destroy', ['teamMember' => $teamMember, 'emergencyContact' => $contact]) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
        ...
        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addEmergencyContactModal">
            <i class="fas fa-plus me-2"></i>Add an emergency contact
        </button>
    </div>
</div>
