{{-- resources/views/store/memberships/create.blade.php --}}
...
<div class="container-fluid">
    ...
    <form action="{{ route('store.memberships.store') }}" method="POST" id="membershipForm">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" 
                                      rows="3" maxlength="360">{{ old('description') }}</textarea>
                            <div class="form-text">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <textarea class="form-control" name="terms_conditions" 
                                  ...
                                  maxlength="3000">{{ old('terms_conditions') }}</textarea>
                        <div class="form-text">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <select class="form-select" name="session_type" id="session-type">
                                        <option value="limited" {{ old('session_type') === 'limited' ? 'selected' : '' }}>Limited</option>
                                        <option value="unlimited" {{ old('session_type') === 'unlimited' ? 'selected' : '' }}>Unlimited</option>
                                    </select>
                                </div>
                                <div class="col-6" id="session-count-container">
                                    <input type="number" class="form-control" name="session_count" 
                                           value="{{ old('session_count', 1) }}" min="1" 
                                           id="session-count">
                                </div>
                            </div>
                            @error('session_type')
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="number" class="form-control" name="validity_duration" 
                                           value="{{ old('validity_duration', 1) }}" min="1" required>
                                </div>
                                <div class="col-6">
                                    <select class="form-select" name="validity_period" required>
                                        <option value="days" {{ old('validity_period') === 'days' ? 'selected' : '' }}>Days</option>
                                        <option value="weeks" {{ old('validity_period') === 'weeks' ? 'selected' : '' }}>Weeks</option>
                                        <option value="months" {{ old('validity_period', 'months') === 'months' ? 'selected' : '' }}>Months</option>
                                        <option value="years" {{ old('validity_period') === 'years' ? 'selected' : '' }}>Years</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" 
                                   ...
                                   id="online_sales" {{ old('online_sales_enabled') ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" 
                                   ...
                                   id="online_redemption" {{ old('online_redemption_enabled') ? 'checked' : '' }}>
