    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('store.services.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('category') is-invalid @enderror" 
                                        ...
                                        <option value="hair" {{ old('category') == 'hair' ? 'selected' : '' }}>Hair Cut & Styling</option>
                                        <option value="coloring" {{ old('category') == 'coloring' ? 'selected' : '' }}>Hair Coloring</option>
                                        <option value="beard" {{ old('category') == 'beard' ? 'selected' : '' }}>Beard Services</option>
                                        <option value="spa" {{ old('category') == 'spa' ? 'selected' : '' }}>Spa & Facial</option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @enderror
                                    <div class="form-text">
                                        Describe what the service includes, benefits, and any special instructions.
                                    </div>
                                </div>
                            </div>
                        </div>
