...
<!-- Trial Banner -->
<div class="alert alert-warning mb-4 hidden" style="display: none;">
                ...
                <div class="row align-items-center">
                    <div class="col-auto">
                        @if(!empty($member->profile_picture))
                            <img src="{{ asset('storage/' . $member->profile_picture) }}" alt="{{ $member->full_name }}" class="rounded-circle" style="width:56px;height:56px;object-fit:cover;" />
                        @else
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#"><i class="fa fa-calendar me-2"></i>View calendar</a></li>
                                    <li><a class="dropdown-item" href="#"><i class="fa fa-clock me-2"></i>View scheduled shifts</a></li>
                                    <li><a class="dropdown-item" href="#"><i class="fa fa-umbrella-beach me-2"></i>Add time off</a></li>
