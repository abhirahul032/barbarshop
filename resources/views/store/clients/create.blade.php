...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fa fa-user-plus text-success me-2"></i>Add New Client
            </h1>
            <p class="text-muted">Create a new client profile with all necessary information</p>
        </div>
    ...
    <form method="POST" action="{{ route('store.clients.store') }}" id="clientForm">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('pronouns') is-invalid @enderror" id="pronouns" name="pronouns">
                                <option value="">Select an option</option>
                                <option value="he/him" {{ old('pronouns') == 'he/him' ? 'selected' : '' }}>He/Him</option>
                                <option value="she/her" {{ old('pronouns') == 'she/her' ? 'selected' : '' }}>She/Her</option>
                                <option value="they/them" {{ old('pronouns') == 'they/them' ? 'selected' : '' }}>They/Them</option>
                                <option value="ze/zir" {{ old('pronouns') == 'ze/zir' ? 'selected' : '' }}>Ze/Zir</option>
                                <option value="other" {{ old('pronouns') == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                            @error('pronouns')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('client_source') is-invalid @enderror" id="client_source" name="client_source">
                                        <option value="walk-in" {{ old('client_source') == 'walk-in' ? 'selected' : '' }}>Walk-in</option>
                                        <option value="referral" {{ old('client_source') == 'referral' ? 'selected' : '' }}>Referral</option>
                                        <option value="website" {{ old('client_source') == 'website' ? 'selected' : '' }}>Website</option>
                                        <option value="social-media" {{ old('client_source') == 'social-media' ? 'selected' : '' }}>Social Media</option>
                                        <option value="email-marketing" {{ old('client_source') == 'email-marketing' ? 'selected' : '' }}>Email Marketing</option>
                                        <option value="other" {{ old('client_source') == 'other' ? 'selected' : '' }}>Other</option>
                                    </select>
                                    ...
                                    <select class="form-select @error('referred_by_client_id') is-invalid @enderror" 
                                        ...
                                        @foreach($existingClients as $existingClient)
                                            <option value="{{ $existingClient->id }}" 
                                                {{ old('referred_by_client_id') == $existingClient->id ? 'selected' : '' }}>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="email_notifications" 
                                   name="email_notifications" value="1" {{ old('email_notifications', true) ? 'checked' : '' }}>
                            <label class="form-check-label" for="email_notifications">Email notifications</label>
                        </div>
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="text_message_notifications" 
                                   name="text_message_notifications" value="1" {{ old('text_message_notifications', true) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="whatsapp_notifications" 
                                   name="whatsapp_notifications" value="1" {{ old('whatsapp_notifications') ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="email_marketing" 
                                   name="email_marketing" value="1" {{ old('email_marketing') ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="text_message_marketing" 
                                   name="text_message_marketing" value="1" {{ old('text_message_marketing') ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="whatsapp_marketing" 
                                   name="whatsapp_marketing" value="1" {{ old('whatsapp_marketing') ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fa fa-save me-2"></i>Create Client
                            </button>
                            <a href="{{ route('store.clients.index') }}" class="btn btn-outline-secondary">
